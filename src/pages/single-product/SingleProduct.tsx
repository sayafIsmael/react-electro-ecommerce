                    ...
                    <div className="row">
                        <div className="col-md-6 col-lg-4 col-xl-5 mb-4 mb-md-0">
                            <Slider {...sliderSettings}>
                                ...
                                data-nav-htmlFor="#sliderSyncingThumb"> */}
                            ...
                            <Slider {...sliderSettings}>
                                ...
                                data-slides-show="5"
                                data-is-thumbs="true"
                                data-nav-htmlFor="#sliderSyncingNav"> */}
                        ...
                        <div className="col-md-6 col-lg-4 col-xl-4 mb-md-6 mb-lg-0">
                            <div className="mb-2">
                                ...
                                <a href="#" className="d-inline-block max-width-150 ml-n2 mb-2"><img className="img-fluid" src="/assets/img/200X60/img1.png" alt="Image Description" /></a>
                                <div className="mb-2">
                        ...
                        <div className="mx-md-auto mx-lg-0 col-md-6 col-lg-4 col-xl-3">
                            <div className="mb-2">
                                <div className="card p-5 border-width-2 border-color-1 borders-radius-17">
                                    <div className="text-gray-9 font-size-14 pb-2 border-color-1 border-bottom mb-3">Availability: <span className="text-green font-weight-bold">26 in stock</span></div>
                                    <div className="mb-3">
                                        <div className="font-size-36">$685.00</div>
                                    </div>
                                    <div className="mb-3">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        {/* <!-- Select --> */}
                                        <select className="js-select selectpicker dropdown-select btn-block col-12 px-0"
                                    ...
                                    <div className="mb-2 pb-0dot5">
                                        <a href="#" className="btn btn-block btn-primary-dark"><i className="ec ec-add-to-cart mr-2 font-size-20"></i> Add to Cart</a>
                                    </div>
                                    <div className="mb-3">
                                        <a href="#" className="btn btn-block btn-dark">Buy Now</a>
                                    </div>
                ...
                <div className="container">
                    <div className="js-scroll-nav">
                        <div className="bg-white pt-4 pb-6 px-xl-11 px-md-5 px-4 mb-6">
                            <div id="Accessories" className="mx-md-2">
                                <div className="position-relative mb-6">
                                    <ul className="nav nav-classic nav-tab nav-tab-lg justify-content-xl-center flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble border-lg-down-bottom-0 pb-1 pb-xl-0 mb-n1 mb-xl-0">
                                        <li className="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
                                            <a className="nav-link active" href="#Accessories">
                                        ...
                                        <li className="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
                                            <a className="nav-link" href="#Specification">
                                                <div className="d-md-flex justify-content-md-center align-items-md-center">
                                                    Specification
                                                </div>
                                            </a>
                        ...
                        <div className="bg-white pt-4 pb-6 px-xl-11 px-md-5 px-4 mb-6 overflow-hidden">
                            <div id="Description" className="mx-md-2">
                                <div className="position-relative mb-6">
                                    <ul className="nav nav-classic nav-tab nav-tab-lg justify-content-xl-center mb-6 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble border-lg-down-bottom-0 pb-1 pb-xl-0 mb-n1 mb-xl-0">
                                        <li className="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
                                ...
                                <div className="mx-md-4 pt-1">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6 text-right">
                                            <img className="img-fluid mr-n4 mr-md-n10 mr-xl-n15" src="/assets/img/580X580/img1.jpg" alt="Image Description" />
                                        </div>
                                        <div className="col-md-6 text-left">
                                            <img className="img-fluid ml-n4 ml-md-n10 ml-xl-n15" src="/assets/img/580X580/img2.jpg" alt="Image Description" />
                                        </div>
                        ...
                        <div className="bg-white py-4 px-xl-11 px-md-5 px-4 mb-6">
                            <div id="Specification" className="mx-md-2">
                                <div className="position-relative mb-6">
                                    <ul className="nav nav-classic nav-tab nav-tab-lg justify-content-xl-center mb-6 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble border-lg-down-bottom-0 pb-1 pb-xl-0 mb-n1 mb-xl-0">
                                        <li className="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
                                            <a className="nav-link" href="#Accessories">
                                        ...
                                        <li className="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
                                            <a className="nav-link active" href="#Specification">
                                                <div className="d-md-flex justify-content-md-center align-items-md-center">
                                                    Specification
                                                </div>
                                            </a>
                        ...
                        <div className="bg-white py-4 px-xl-11 px-md-5 px-4 mb-6">
                            <div id="Reviews" className="mx-md-2">
                                <div className="position-relative mb-6">
                                    <ul className="nav nav-classic nav-tab nav-tab-lg justify-content-xl-center mb-6 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble border-lg-down-bottom-0 pb-1 pb-xl-0 mb-n1 mb-xl-0">
                                        <li className="nav-item flex-shrink-0 flex-xl-shrink-1 z-index-2">
                                            <a className="nav-link" href="#Accessories">
                                                    ...
                                                    <a className="row align-items-center mx-gutters-2 font-size-1" href="javascript:;">
                                                        ...
                                                        <div className="col-auto mb-2 mb-md-0">
                                                            <div className="progress ml-xl-5" style={{ height: 10, width: 200 }}>
                                                                <div className="progress-bar" role="progressbar" style={{ width: "100%" }} ></div> {/**ariaValuenow="100" aria-valuemin="0" aria-valuemax="100" */}
                                                            </div>
                                                        </div>
