...
import ShopSelectedCategory from './shop-selected-category/ShopSelectedCategory'

export default function Categories(){
    return (
        <div className="mb-8 border border-width-2 border-color-3 borders-radius-6">
                {/* <!-- List --> */}
                <ul id="sidebarNav" className="list-unstyled mb-0 sidebar-navbar">
                    <li id="sidebarNavCategory">
                        <a className="dropdown-toggle dropdown-toggle-collapse dropdown-title" href="javascript:;" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="sidebarNavCategoryCollapse" data-target="#sidebarNavCategoryCollapse">Browse Categories</a>
                        <div id="sidebarNavCategoryCollapse" className="collapse show" data-parent="#sidebarNavCategory">
                            <ul className="list-unstyled sidebar-navbar view-all view-one">
                                <li>
