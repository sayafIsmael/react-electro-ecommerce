                                ...
                                <div className="product-item__inner p-md-3 row no-gutters">
                                    ...
                                    <div className="col product-item__body pl-2 pl-lg-3 mr-xl-2 mr-wd-1">
                                        ...
                                        <div className="flex-center-between mb-3">
                                            ...
                                            <div className="d-none d-xl-block prodcut-add-cart">
                                                <a href="#" className="btn-add-cart btn-primary transition-3d-hover" ><i className="ec ec-add-to-cart"></i></a>
                                            </div>
                                        </div>
                                        <div className="product-item__footer">
                                            <div className="border-top pt-2 flex-center-between flex-wrap">
                                                <a href="#" className="text-gray-6 font-size-13" ><i className="ec ec-compare mr-1 font-size-15"></i> Compare</a>
                                                <a href="#" className="text-gray-6 font-size-13" ><i className="ec ec-favorites mr-1 font-size-15"></i> Wishlist</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
